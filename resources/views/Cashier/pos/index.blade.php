                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
                            ...
                            <button @click="processPayment()" 
                                    ...
                                    class="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg font-black text-xl shadow-lg transform transition active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-32 h-12">
                                <span x-show="!isProcessing">BAYAR</span>
                                <span x-show="isProcessing" class="text-sm font-medium flex items-center">
